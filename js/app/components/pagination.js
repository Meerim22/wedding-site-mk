...
export const pagination = (() => {
    ...
    const buttonAction = (button) => {
        ...
        const next = () => {
            pageNow += perPage;
            button.innerHTML = 'Вперед' + button.innerHTML;
            process();
        };

        const prev = () => {
            pageNow -= perPage;
            button.innerHTML = button.innerHTML + 'Назад';
            process();
        };
    ...
    const init = () => {
        ...
        <ul class="pagination mb-2 shadow-sm rounded-4">
            <li class="page-item disabled" id="previous">
                <button class="page-link rounded-start-4 fw-medium" onclick="undangan.comment.pagination.previous(this)" data-offline-disabled="false">
                    <i class="fa-solid fa-circle-left me-1"></i>Назад
                </button>
            </li>
            <li class="page-item disabled">
                <span class="page-link text-theme-auto fw-bold" id="page"></span>
            </li>
            <li class="page-item" id="next">
                <button class="page-link rounded-end-4 fw-medium" onclick="undangan.comment.pagination.next(this)" data-offline-disabled="false">
                    Вперед<i class="fa-solid fa-circle-right ms-1"></i>
                </button>
            </li>
        </ul>`;
